<%@ Page Title="Crafting Requests - Blackjack Tools" Language="C#" MasterPageFile="~/Site.master"
    AutoEventWireup="true" CodeBehind="Crafting.aspx.cs" Inherits="Blackjack_Tools._Default" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <asp:Label ID="lbl_Crafting_Header" runat="server" Font-Bold="True" Font-Size="Large"
        Text="Crafting Requests"></asp:Label>
    <asp:FormView ID="FormView_InsertC_Request" runat="server" DataSourceID="SqlDataSource_CraftingUnfulfilled"
        ...
        <InsertItemTemplate>
            <table>
                ...
                <tr>
                    <td>
                        <asp:Label ID="Label_ItemName" runat="server" Font-Bold="True" Font-Size="Medium"
                            Text="Item: "></asp:Label>
                        <asp:DropDownList ID="DropDownList1" runat="server" DataSourceID="SqlDataSourceCraftedItemDB"
                            DataTextField="ItemName" DataValueField="ItemID" SelectedValue='<%# Bind("ItemID") %>'>
                        </asp:DropDownList>
                    </td>
                    <td>
                        <asp:Label ID="Label7" runat="server" Font-Bold="True" Font-Size="Medium" Text="Amount: "></asp:Label>
                        <asp:TextBox ID="txt_Amount" runat="server" Text='<%# Bind("Amount") %>' Width="64px"></asp:TextBox>
                        <asp:RangeValidator ID="RangeValidator1" runat="server" ControlToValidate="txt_Amount"
                        ...
                        <ajaxToolkit:FilteredTextBoxExtender ID="txt_Amount_FilteredTextBoxExtender" runat="server"
                            Enabled="True" TargetControlID="txt_Amount" ValidChars="1234567890">
                        </ajaxToolkit:FilteredTextBoxExtender>
                    </td>
                    <td>
                        <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="Medium" Text="HQ: "></asp:Label>
                    ...
                    <td>
                        <asp:ImageButton ID="ImageButton2" runat="server" CommandName="Cancel" ImageUrl="~/Resources/Cancel__Red.png"
                            ToolTip="Clear" />
                    </td>
                </tr>
                <tr>
                    <td>
                        <asp:Label ID="Label8" runat="server" Font-Bold="True" Font-Size="Medium" Text="Reward Amount: "></asp:Label>
                        <asp:TextBox ID="TextBox4" runat="server" Text='<%# Bind("RewardAmount") %>' Width="64px"></asp:TextBox>
                        <ajaxToolkit:FilteredTextBoxExtender ID="TextBox4_FilteredTextBoxExtender" runat="server"
                            Enabled="True" TargetControlID="TextBox4" ValidChars="1234567890">
                        </ajaxToolkit:FilteredTextBoxExtender>
                    ...
                    <td colspan="3">
                        <asp:Label ID="Label9" runat="server" Font-Bold="True" Font-Size="Medium" Text="Reward Type: "></asp:Label>
                        <asp:DropDownList ID="DropDownList2" runat="server" DataSourceID="SqlDataSourceRewardDB"
                ...
                <tr>
                    <td colspan="5">
                        <asp:SqlDataSource ID="SqlDataSourceCraftedItemDB" runat="server" ConnectionString="<%$ ConnectionStrings:BlackjackTools_DB %>"
                            SelectCommand="SELECT ItemID, ItemName FROM Items WHERE (CraftingGathering = 0) ORDER BY ItemName">
                        </asp:SqlDataSource>
                        <asp:SqlDataSource ID="SqlDataSourceRewardDB" runat="server" ConnectionString="<%$ ConnectionStrings:BlackjackTools_DB %>"
                            SelectCommand="SELECT [RewardID], [RewardName] FROM [Rewards]"></asp:SqlDataSource>
                    </td>
                </tr>
            </table>
        </InsertItemTemplate>
    ...
    <asp:UpdatePanel ID="UpdatePanelCrafting" runat="server">
        <ContentTemplate>
            ...
            <asp:GridView ID="GridView_Crafting" runat="server" AllowPaging="True" AllowSorting="True"
                ...
                EnableModelValidation="True" Width="100%" OnRowCommand="GridView_Crafting_RowCommand"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Reward" SortExpression="RewardAmount">
                        ...
                        <ItemStyle HorizontalAlign="Right" />
                        <ItemTemplate>
                            <asp:Label ID="Label1" runat="server" Text='<%# Bind("RewardAmount", "{0:#,###,##0}") %>'
                    ...
                    <asp:TemplateField HeaderText="Checked Out By" SortExpression="CheckedOutBy_User_ID">
                        ...
                        <ItemTemplate>
                            ...
                            <asp:HyperLink ID="hpl_CheckedOutBy" runat="server" NavigateUrl='<%# Eval("CheckedOutBy_Name", "default.aspx?User={0}") %>'
                    ...
                    <asp:TemplateField ShowHeader="False">
                        <ItemTemplate>
                            <asp:ImageButton ID="imgB_Cancel" runat="server" CommandName="Cancel" ImageUrl="~/Resources/Cancel__Red.png"
                                ToolTip="Cancel Job Request" CausesValidation="False" />
                            <asp:ImageButton ID="imgB_CheckOut" runat="server" CommandName="Edit" ImageUrl="~/Resources/green-checkmark.png"
                                ToolTip="Check Out This Job" CausesValidation="False" />
                            <asp:ImageButton ID="imgB_Drop" runat="server" CommandName="Delete" ImageUrl="~/Resources/red-x-icon.png"
                                ToolTip="Drop This Job" CausesValidation="False" />
                            <asp:ImageButton ID="imgB_Fulfill" runat="server" CommandName="Update" ImageUrl="~/Resources/icon_ArrowNext.png"
                                ToolTip="Mark This Job as Fulfilled and Ready for pickup" CausesValidation="False" />
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
                <EmptyDataTemplate>
                    <asp:Label ID="Label6" runat="server" Font-Bold="True" Font-Size="Medium" Text="There are currently no unfulfilled crafting jobs"></asp:Label>
                </EmptyDataTemplate>
            </asp:GridView>
        </ContentTemplate>
        <Triggers>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <asp:Panel ID="pnl_CraftingFulfilled_Body" runat="server" OnPreRender="pnl_CraftingFulfilled_Body_PreRender">
                <asp:GridView ID="GridView_CraftingFulfilled" runat="server" AllowPaging="True" AllowSorting="True"
                    ...
                    EnableModelValidation="True" Width="100%" OnRowCommand="GridView_CraftingFulfilled_RowCommand"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Checked Out By" SortExpression="CheckedOutBy_User_ID">
                            ...
                            <ItemTemplate>
                                <asp:Image ID="Image2" runat="server" ImageAlign="Right" ImageUrl="~/Resources/info_icon.png"
                                    ToolTip='<%# Bind("Date_CheckedOut", "{0:d}") %>' />
                                <asp:Image ID="img_CFlair" runat="server" />
                        ...
                        <asp:TemplateField HeaderText="Fulfilled" SortExpression="Date_Fulfilled">
                            ...
                            <ItemTemplate>
                                <asp:CheckBox ID="CheckBox2" runat="server" Checked='<%# Bind("Fulfilled") %>' Enabled="False" />
                                <asp:Image ID="Image3" runat="server" ImageAlign="Right" ImageUrl="~/Resources/info_icon.png"
                                    ToolTip='<%# Bind("Date_Fulfilled", "{0:d}") %>' Visible='<%# Bind("Fulfilled") %>' />
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField ShowHeader="False">
                            <ItemTemplate>
                                <asp:ImageButton ID="imgB_Verify" runat="server" CausesValidation="False" CommandName="Update"
                                    ImageUrl="~/Resources/green-checkmark.png" ToolTip="Verify Receipt of Goods" />
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
                </asp:GridView>
    ...
    <asp:SqlDataSource ID="SqlDataSource_CraftingUnfulfilled" runat="server" ConnectionString="<%$ ConnectionStrings:BlackjackTools_DB %>"
        InsertCommand="DECLARE @Today DateTime; SET @Today = GetDate();
            INSERT INTO CraftingRequests_DB(Requester_ID, CraftableItem_ID, HQ, Date_Requested, Amount, RewardAmount, RewardID) 
            VALUES (@UserName, @ItemID, @HQ, @Today, @Amount, @RewardAmount, @RewardID)"
        SelectCommand="SELECT CraftingRequests_DB.Requester_ID, CraftingRequests_DB.Date_Requested, CraftingRequests_DB.CheckedOutBy_User_ID, CraftingRequests_DB.Date_CheckedOut, CraftingRequests_DB.Date_Fulfilled, CraftingRequests_DB.Request_ID, CraftingRequests_DB.HQ, CraftingRequests_DB.Amount, Rewards.RewardName, CraftingRequests_DB.RewardAmount, CraftingRequests_DB.RewardID, CraftingRequests_DB.Fulfilled, aspnet_Users.UserName AS Requester_Name, vw_aspnet_Users.UserName AS CheckedoutBy_Name, aspnet_Users.FulfilledCount AS Request_Fulfilled, vw_aspnet_Users.FulfilledCount AS Check_Fulfilled, Items.ItemName, Items.LinkURL FROM CraftingRequests_DB INNER JOIN Rewards ON CraftingRequests_DB.RewardID = Rewards.RewardID INNER JOIN aspnet_Users ON CraftingRequests_DB.Requester_ID = aspnet_Users.UserId INNER JOIN Items ON CraftingRequests_DB.CraftableItem_ID = Items.ItemID LEFT OUTER JOIN vw_aspnet_Users ON CraftingRequests_DB.CheckedOutBy_User_ID = vw_aspnet_Users.UserId WHERE (CraftingRequests_DB.Fulfilled = 0) ORDER BY CraftingRequests_DB.Date_Requested DESC">
        <InsertParameters>
    ...
    <asp:SqlDataSource ID="SqlDataSource_CraftingFulfilled" runat="server" ConnectionString="<%$ ConnectionStrings:BlackjackTools_DB %>"
        SelectCommand="SELECT CraftingRequests_DB.Requester_ID, CraftingRequests_DB.Date_Requested, CraftingRequests_DB.CheckedOutBy_User_ID, CraftingRequests_DB.Date_CheckedOut, CraftingRequests_DB.Date_Fulfilled, CraftingRequests_DB.Request_ID, CraftingRequests_DB.HQ, CraftingRequests_DB.Verified, CraftingRequests_DB.Date_Verified, CraftingRequests_DB.Amount, Rewards.RewardName, CraftingRequests_DB.RewardAmount, CraftingRequests_DB.RewardID, CraftingRequests_DB.Fulfilled, aspnet_Users.UserName AS Requester_Name, vw_aspnet_Users.UserName AS CheckedoutBy_Name, aspnet_Users.FulfilledCount AS Request_Fulfilled, vw_aspnet_Users.FulfilledCount AS Check_Fulfilled, Items.ItemName, Items.LinkURL FROM CraftingRequests_DB INNER JOIN Rewards ON CraftingRequests_DB.RewardID = Rewards.RewardID INNER JOIN aspnet_Users ON CraftingRequests_DB.Requester_ID = aspnet_Users.UserId INNER JOIN Items ON CraftingRequests_DB.CraftableItem_ID = Items.ItemID LEFT OUTER JOIN vw_aspnet_Users ON CraftingRequests_DB.CheckedOutBy_User_ID = vw_aspnet_Users.UserId WHERE (CraftingRequests_DB.Fulfilled = 1) ORDER BY CraftingRequests_DB.Date_Requested DESC">
    </asp:SqlDataSource>
</asp:Content>
