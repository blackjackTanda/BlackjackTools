                    ...
                    <tr>
                        <td valign="top" width="50%">
                            ...
                            <asp:SqlDataSource ID="SqlDataSource_CraftingJobs" runat="server" ConnectionString="<%$ ConnectionStrings:BlackjackTools_DB %>"
                                ...
                                SelectCommand="SELECT CraftingRequests_DB.Requester_ID, CraftingRequests_DB.Date_Requested, CraftingRequests_DB.CheckedOutBy_User_ID, CraftingRequests_DB.Date_CheckedOut, CraftingRequests_DB.Fulfilled, CraftingRequests_DB.Date_Fulfilled, CraftingRequests_DB.Request_ID, CraftingRequests_DB.HQ, CraftingRequests_DB.Verified, CraftingRequests_DB.Date_Verified, CraftingRequests_DB.Amount, CraftedItems.ItemName, CraftedItems.LinkURL, Rewards.RewardName, CraftingRequests_DB.RewardAmount, CraftingRequests_DB.RewardID, aspnet_Users.UserName AS Requester_Name, aspnet_Users.FulfilledCount FROM CraftingRequests_DB INNER JOIN CraftedItems ON CraftingRequests_DB.CraftableItem_ID = CraftedItems.ItemID INNER JOIN Rewards ON CraftingRequests_DB.RewardID = Rewards.RewardID INNER JOIN aspnet_Users ON CraftingRequests_DB.Requester_ID = aspnet_Users.UserId WHERE (CraftingRequests_DB.CheckedOutBy_User_ID = @CheckedOutBy_User_ID) AND (CraftingRequests_DB.Fulfilled = 0)">
                                <SelectParameters>
                        ...
                        <td valign="top">
                            ...
                            <asp:SqlDataSource ID="SqlDataSource_GatheringJobs" runat="server" ConnectionString="<%$ ConnectionStrings:BlackjackTools_DB %>"
                                ...
                                SelectCommand="SELECT GatheringRequests_DB.Requester_ID, GatheringRequests_DB.Amount, GatheringRequests_DB.Date_Requested, GatheringRequests_DB.CheckedOutBy_User_ID, GatheringRequests_DB.Date_CheckedOut, GatheringRequests_DB.Fulfilled, GatheringRequests_DB.Date_Fulfilled, GatheringRequests_DB.Request_ID, GatheringRequests_DB.HQ, GatheringRequests_DB.Verified, GatheringRequests_DB.Date_Verified, GatheredItems.ItemName, GatheredItems.LinkURL, GatheringRequests_DB.RewardAmount, GatheringRequests_DB.RewardID, Rewards.RewardName, aspnet_Users.UserName AS Requester_Name, aspnet_Users.FulfilledCount FROM GatheringRequests_DB INNER JOIN GatheredItems ON GatheringRequests_DB.GatherableItem_ID = GatheredItems.ItemID INNER JOIN Rewards ON GatheringRequests_DB.RewardID = Rewards.RewardID INNER JOIN aspnet_Users ON GatheringRequests_DB.Requester_ID = aspnet_Users.UserId WHERE (GatheringRequests_DB.CheckedOutBy_User_ID = @CheckedOutBy_User_ID) AND (GatheringRequests_DB.Fulfilled = 0)">
                                <SelectParameters>
                                    <asp:SessionParameter Name="CheckedOutBy_User_ID" 
                                        SessionField="CurrentlyViewedUserID" Type="String" />
                                </SelectParameters>
                    ...
                    <tr>
                        <td valign="top" width="50%">
                            ...
                            <asp:SqlDataSource ID="SqlDataSource_CraftingJobsIFulfilled" runat="server" ConnectionString="<%$ ConnectionStrings:BlackjackTools_DB %>"
                                ...
                                SelectCommand="SELECT CraftingRequests_DB.Requester_ID, CraftingRequests_DB.Date_Requested, CraftingRequests_DB.CheckedOutBy_User_ID, CraftingRequests_DB.Date_CheckedOut, CraftingRequests_DB.Fulfilled, CraftingRequests_DB.Date_Fulfilled, CraftingRequests_DB.Request_ID, CraftingRequests_DB.HQ, CraftingRequests_DB.Verified, CraftingRequests_DB.Date_Verified, CraftingRequests_DB.Amount, CraftedItems.ItemName, CraftedItems.LinkURL, Rewards.RewardName, CraftingRequests_DB.RewardAmount, CraftingRequests_DB.RewardID, aspnet_Users.UserName AS Requester_Name, aspnet_Users.FulfilledCount FROM CraftingRequests_DB INNER JOIN CraftedItems ON CraftingRequests_DB.CraftableItem_ID = CraftedItems.ItemID INNER JOIN Rewards ON CraftingRequests_DB.RewardID = Rewards.RewardID INNER JOIN aspnet_Users ON CraftingRequests_DB.Requester_ID = aspnet_Users.UserId WHERE (CraftingRequests_DB.CheckedOutBy_User_ID = @CheckedOutBy) AND (CraftingRequests_DB.Fulfilled = 1) ORDER BY CraftingRequests_DB.Date_Fulfilled DESC">
                                <SelectParameters>
                        ...
                        <td valign="top">
                            ...
                            <asp:SqlDataSource ID="SqlDataSource_GatheringJobsIFulfilled" runat="server" ConnectionString="<%$ ConnectionStrings:BlackjackTools_DB %>"
                                ...
                                SelectCommand="SELECT GatheringRequests_DB.Requester_ID, GatheringRequests_DB.Amount, GatheringRequests_DB.Date_Requested, GatheringRequests_DB.CheckedOutBy_User_ID, GatheringRequests_DB.Date_CheckedOut, GatheringRequests_DB.Fulfilled, GatheringRequests_DB.Date_Fulfilled, GatheringRequests_DB.Request_ID, GatheringRequests_DB.HQ, GatheringRequests_DB.Verified, GatheringRequests_DB.Date_Verified, GatheredItems.LinkURL, GatheredItems.ItemName, Rewards.RewardName, GatheringRequests_DB.RewardAmount, GatheringRequests_DB.RewardID, aspnet_Users.UserName AS Requester_Name, aspnet_Users.FulfilledCount FROM GatheringRequests_DB INNER JOIN GatheredItems ON GatheringRequests_DB.GatherableItem_ID = GatheredItems.ItemID INNER JOIN Rewards ON GatheringRequests_DB.RewardID = Rewards.RewardID INNER JOIN aspnet_Users ON GatheringRequests_DB.Requester_ID = aspnet_Users.UserId WHERE (GatheringRequests_DB.Fulfilled = 1) AND (GatheringRequests_DB.CheckedOutBy_User_ID = @CheckedOutBy) ORDER BY GatheringRequests_DB.Date_Fulfilled DESC">
                                <SelectParameters>
                                    <asp:SessionParameter Name="CheckedOutBy" 
                                        SessionField="CurrentlyViewedUserID" />
                                </SelectParameters>
                    ...
                    <tr>
                        <td valign="top" width="50%">
                            ...
                            <asp:SqlDataSource ID="SqlDataSource_MyFulfilledCraftingJobs" runat="server" ConnectionString="<%$ ConnectionStrings:BlackjackTools_DB %>"
                                ...
                                SelectCommand="SELECT CraftingRequests_DB.Requester_ID, CraftingRequests_DB.Date_Requested, CraftingRequests_DB.CheckedOutBy_User_ID, CraftingRequests_DB.Date_CheckedOut, CraftingRequests_DB.Fulfilled, CraftingRequests_DB.Date_Fulfilled, CraftingRequests_DB.Request_ID, CraftingRequests_DB.HQ, CraftingRequests_DB.Verified, CraftingRequests_DB.Date_Verified, CraftingRequests_DB.Amount, CraftedItems.ItemName, CraftedItems.LinkURL, Rewards.RewardName, CraftingRequests_DB.RewardAmount, CraftingRequests_DB.RewardID, aspnet_Users.UserName AS CheckedOutBy_Name, aspnet_Users.FulfilledCount FROM CraftingRequests_DB INNER JOIN CraftedItems ON CraftingRequests_DB.CraftableItem_ID = CraftedItems.ItemID INNER JOIN Rewards ON CraftingRequests_DB.RewardID = Rewards.RewardID INNER JOIN aspnet_Users ON CraftingRequests_DB.CheckedOutBy_User_ID = aspnet_Users.UserId WHERE (CraftingRequests_DB.Requester_ID = @Requester_ID) AND (CraftingRequests_DB.Fulfilled = 1) ORDER BY CraftingRequests_DB.Date_Fulfilled DESC">
                                <SelectParameters>
                                    <asp:SessionParameter Name="Requester_ID" SessionField="CurrentlyViewedUserID" 
                                        Type="String" />
                                </SelectParameters>
                        ...
                        <td valign="top">
                            ...
                            <asp:SqlDataSource ID="SqlDataSource_MyFulfilledGatheringJobs" runat="server" ConnectionString="<%$ ConnectionStrings:BlackjackTools_DB %>"
                                ...
                                SelectCommand="SELECT GatheringRequests_DB.Requester_ID, GatheringRequests_DB.Amount, GatheringRequests_DB.Date_Requested, GatheringRequests_DB.CheckedOutBy_User_ID, GatheringRequests_DB.Date_CheckedOut, GatheringRequests_DB.Fulfilled, GatheringRequests_DB.Date_Fulfilled, GatheringRequests_DB.Request_ID, GatheringRequests_DB.HQ, GatheringRequests_DB.Verified, GatheringRequests_DB.Date_Verified, GatheredItems.ItemName, GatheredItems.LinkURL, Rewards.RewardName, GatheringRequests_DB.RewardAmount, GatheringRequests_DB.RewardID, aspnet_Users.UserName AS CheckedOutBy_Name, aspnet_Users.FulfilledCount FROM GatheringRequests_DB INNER JOIN GatheredItems ON GatheringRequests_DB.GatherableItem_ID = GatheredItems.ItemID INNER JOIN Rewards ON GatheringRequests_DB.RewardID = Rewards.RewardID INNER JOIN aspnet_Users ON GatheringRequests_DB.CheckedOutBy_User_ID = aspnet_Users.UserId WHERE (GatheringRequests_DB.Requester_ID = @Requester_ID) AND (GatheringRequests_DB.Fulfilled = 1) ORDER BY GatheringRequests_DB.Date_Fulfilled DESC">
                                <SelectParameters>
                                    <asp:SessionParameter Name="Requester_ID" SessionField="CurrentlyViewedUserID" 
                                        Type="String" />
                                </SelectParameters>
